                ...
                <?php while ( $parent->have_posts() ) : $parent->the_post(); ?>
                    ...
                    <div class="subsection-cards">
                        <div class="subsection-cards__item">
                            <div class="avatar--success-stories" style="background-color:#576;background-image: url('<?php echo get_the_post_thumbnail_url(  $post->ID, 'medium_large' ) ;?>';"><?php echo get_the_post_thumbnail_url(  $post->ID, 'medium_large' ) ;?></div>
                        </div>
                        <div class="subsection-cards__item">
